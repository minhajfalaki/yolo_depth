from backend import (TinyYoloFeature, BaseFeatureExtractor)
...
def import_feature_extractor(backend, input_size):
    ...
    if backend == 'Tiny Yolo':
        ...
        raise RuntimeError('Architecture not supported! Only support Tiny Yolo,at the moment!')
...
def create_backup(config):
    ...
    readme_message = "This is to train depth images using Tiny Yolo v2"
